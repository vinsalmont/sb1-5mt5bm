...
import { Apple, CheckCircle2, Smartphone, Shield, Gauge, Cloud } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: "Leverage iOS's full potential with native development"
    },
    {
      icon: Shield,
    ...
    },
    {
      ...
      description: "Smooth animations and responsive interactions"
    },
    {
      icon: Cloud,
      ...
      <div className="container mx-auto px-6">
        ...
        >
          <div className="flex items-center justify-center gap-4 mb-6">
            <Apple className="w-12 h-12 text-accent" />
            <h1 className="text-5xl font-bold">iOS DEVELOPMENT</h1>
          </div>
          <p className="text-gray-400 max-w-2xl mx-auto font-mono">
            Create exceptional iOS applications that deliver outstanding user experiences.
          </p>
        </motion.div>
        ...
        >
          <h2 className="text-3xl font-bold mb-6">Ready to Build Your iOS App?</h2>
          <p className="text-gray-400 max-w-2xl mx-auto mb-8 font-mono">
            Let's create an exceptional iOS application that your users will love.
          </p>
